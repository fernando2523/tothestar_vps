...
export default function Shipping() {
  ...
  async function loaddataorder(
    ...
    await axios({
      method: "post",
      url: `https://backapi.tothestarss.com/v1/orderresellerpending`,
      data: {
  ...
  async function ordercount(store: any, query: any, date: any) {
    await axios({
      method: "post",
      url: `https://backapi.tothestarss.com/v1/ordercountresellerpending`,
      data: {
        store: store,
        query: query,
        date: date,
  ...
  async function getheaderpesanan(
    ...
    await axios({
      method: "post",
      url: `https://backapi.tothestarss.com/v1/getheaderpesananresellerpending`,
      data: {
        status_pesanan: status_pesanan,
        query: query,
        store: store,
  ...
  async function getstore(role: any) {
    await axios({
      method: "post",
      url: `https://backapi.tothestarss.com/v1/getstore_sales`,
      data: {
        role: role,
      },
    })
  ...
  async function openmodalpaysatuan(
    ...
    await axios
      .post(`https://backapi.tothestarss.com/v1/gethistorypay`, {
                  ...
                  <div className="basis-1/3 text-xl font-bold p-5 text-lime-500 ">
                    <div className="mt-1">
                      <Image
                        ...
                        src={`https://backapi.tothestarss.com/public/images/cash1.png`}
                ...
                <div className="flex flex-row">
                  <div className="basis-1/3 text-xl font-bold p-5 text-blue-600">
                    <div className="mt-1">
                      <Image
                        className="w-[40%] h-[25%] m-auto"
                        src={`https://backapi.tothestarss.com/public/images/bca1.png`}
                        alt="Picture of the author"
                        width={100}
                        height={100}
                        placeholder="blur"
