...
export default function NotaBarang() {
    ...
    const { data, error, isLoading, mutate } = useSWR(`https://apitest.lokigudang.com/notabarang/${Query}/${Store}/${date}/${Filter_Supplier}/${Filter_Status}/${Filter_Payment}`, fetcher);

    const { data: report_data, error: report_error, isLoading: report_isLoading, mutate: report_mutate } = useSWR(`https://apitest.lokigudang.com/get_nota/${Store}/${date}/${Filter_Supplier}/${Filter_Status}/${Filter_Payment}`, fetcher);
