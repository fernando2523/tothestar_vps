...
export default function Store() {
  ...
  async function loaddatastore() {
    ...
    await axios({
      method: "get",
      url: `https://backapi.tothestarss.com/v1/getstores`,
    })
  ...
  async function getstore_warehouse() {
    await axios({
      method: "get",
      url: `https://backapi.tothestarss.com/v1/getstore_warehouse`,
    })
      .then(function (response) {
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://backapi.tothestarss.com/v1/addstore", data)
      .then(function (response) {
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://backapi.tothestarss.com/v1/editstore`, { data, id })
      .then(function (response) {
        // console.log(response.data);
        loaddatastore();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://backapi.tothestarss.com/v1/deletestore`, { id })
      .then(function (response) {
        // console.log(response.data);
        loaddatastore();
      });
