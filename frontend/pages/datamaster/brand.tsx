...
export default function Brand() {
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://backapi.tothestarss.com/v1/addbrand", data)
      .then(function (response) {
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://backapi.tothestarss.com/v1/editbrand`, { data, id })
      .then(function (response) {
        // console.log(response.data);
        loaddatabrand();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://backapi.tothestarss.com/v1/deletebrand`, { id })
      .then(function (response) {
        // console.log(response.data);
        loaddatabrand();
      });
