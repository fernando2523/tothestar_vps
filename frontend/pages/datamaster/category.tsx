...
export default function Category() {
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://backapi.tothestarss.com/v1/addcategory", data)
      .then(function (response) {
  ...
  const onSubmitUpdate = async (data: any) => {
    await axios
      .post(`https://backapi.tothestarss.com/v1/editcategory`, { data, id })
      .then(function (response) {
        // console.log(response.data);
        loaddatacategory();
      });
  ...
  async function deleteData() {
    await axios
      .post(`https://backapi.tothestarss.com/v1/deletecategory`, { id })
      .then(function (response) {
        // console.log(response.data);
        loaddatacategory();
      });
